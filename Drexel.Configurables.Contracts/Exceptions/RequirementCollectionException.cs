...
{
    /// <summary>
    /// The exception that is thrown when an error occurs while using a <see cref="RequirementCollection"/>.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequirementCollectionException"/> class.
        /// </summary>
        /// <param name="message">
