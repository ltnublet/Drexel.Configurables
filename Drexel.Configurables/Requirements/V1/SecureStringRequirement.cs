...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="SecureString"/>.
    /// </summary>
    public sealed class SecureStringRequirement : IRequirement<SecureString>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecureStringRequirement"/> class.
        /// </summary>
        /// <param name="id">
        ...
        /// </param>
        public SecureStringRequirement(
            Guid id,
            string name,
            string description,
            bool isOptional,
            EnumerableInfo? enumerableInfo = null,
            IReadOnlyCollection<SetRestrictionInfo<SecureString>> restrictedToSet = null,
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<SecureString>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<SecureString> Type => RequirementTypes.V1.SecureString;
