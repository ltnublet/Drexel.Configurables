...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="long"/>.
    /// </summary>
    public sealed class Int64Requirement : IRequirement<long>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int64Requirement"/> class.
        /// </summary>
        /// <param name="id">
        ...
        /// </param>
        public Int64Requirement(
            Guid id,
            string name,
            string description,
            bool isOptional,
            EnumerableInfo? enumerableInfo = null,
            IReadOnlyCollection<SetRestrictionInfo<long>> restrictedToSet = null,
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<long>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<long> Type => RequirementTypes.V1.Int64;
