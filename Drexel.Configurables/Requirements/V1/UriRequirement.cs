...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="Uri"/>.
    /// </summary>
    public sealed class UriRequirement : IRequirement<Uri>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UriRequirement"/> class.
        /// </summary>
        /// <param name="id">
        ...
        /// </param>
        public UriRequirement(
            Guid id,
            string name,
            string description,
            bool isOptional,
            EnumerableInfo? enumerableInfo = null,
            IReadOnlyCollection<SetRestrictionInfo<Uri>> restrictedToSet = null,
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<Uri>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<Uri> Type => RequirementTypes.V1.Uri;
