...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="bool"/>.
    /// </summary>
    public sealed class BoolRequirement : IRequirement<bool>
    {
        /// <summary>
        ...
        /// </param>
        public BoolRequirement(
            Guid id,
            string name,
            string description,
            bool isOptional,
            EnumerableInfo? enumerableInfo = null,
            IReadOnlyCollection<SetRestrictionInfo<bool>> restrictedToSet = null,
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<bool>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<bool> Type => RequirementTypes.V1.Bool;
