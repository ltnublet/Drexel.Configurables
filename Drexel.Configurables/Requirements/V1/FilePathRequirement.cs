...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="FilePath"/>.
    /// </summary>
    public sealed class FilePathRequirement : IRequirement<FilePath>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilePathRequirement"/> class.
        /// </summary>
        /// <param name="id">
        ...
        /// </param>
        /// <param name="pathInteractor">
        /// The path interactor of this requirement.
        /// </param>
        ...
        /// </param>
        public FilePathRequirement(
            Guid id,
            string name,
            string description,
            bool isOptional,
            IPathInteractor pathInteractor,
            EnumerableInfo? enumerableInfo = null,
            IReadOnlyCollection<SetRestrictionInfo<FilePath>> restrictedToSet = null,
            ...
            IReadOnlyCollection<IRequirement> exclusivewith = null)
        {
            ...
            this.Type = RequirementTypes.V1.GetFilePathType(
                pathInteractor ?? throw new ArgumentNullException(nameof(pathInteractor)));
        }
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<FilePath>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<FilePath> Type { get; }
