...
{
    /// <summary>
    /// Represents an <see cref="IRequirement{T}"/> of type <see cref="string"/>.
    /// </summary>
    public sealed class StringRequirement : IRequirement<string>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringRequirement"/> class.
        /// </summary>
        /// <param name="id">
        ...
        public StringRequirement(
            ...
            IReadOnlyCollection<SetRestrictionInfo<string>> restrictedToSet = null,
        ...
        /// </summary>
        public IReadOnlyCollection<SetRestrictionInfo<string>> RestrictedToSet { get; }

        /// <summary>
        /// Gets the type of this requirement.
        /// </summary>
        public IRequirementType<string> Type => RequirementTypes.V1.String;
